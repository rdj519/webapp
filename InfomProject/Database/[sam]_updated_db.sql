...
CREATE TABLE IF NOT EXISTS `mydb`.`transaction` (
  ...
  INDEX `fk_transaction_resource1_idx` (`id_resource` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`rating` (
  ...
  PRIMARY KEY (`id_company`),
  UNIQUE INDEX `supplier_id_UNIQUE` (`id_company` ASC) VISIBLE,
  INDEX `fk_rating_resident_user1_idx` (`resident_user_id_user` ASC) VISIBLE,
  INDEX `fk_rating_company1_idx` (`company_id_company` ASC) VISIBLE,
