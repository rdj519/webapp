...
CREATE TABLE IF NOT EXISTS `mydb`.`supplier_user` (
  ...
  `end_date` DATETIME NULL,
  `rating_supplier_id` INT NOT NULL,
  `rating_supplier_id1` INT NOT NULL,
  PRIMARY KEY (`id_user`, `rating_supplier_id`),
  INDEX `fk_supplier_user_rating1_idx` (`rating_supplier_id1` ASC) VISIBLE,
  CONSTRAINT `fk_supplier_user_user1`
    FOREIGN KEY (`id_user`)
    REFERENCES `mydb`.`user` (`id_user`),
  CONSTRAINT `fk_supplier_user_rating1`
    FOREIGN KEY (`rating_supplier_id1`)
    REFERENCES `mydb`.`rating` (`supplier_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `mydb`.`resident_user` (
  ...
  `group_leader_id_user` INT(10) UNSIGNED NOT NULL,
  `rating_supplier_id` INT NOT NULL,
  `rating_supplier_id1` INT NOT NULL,
  PRIMARY KEY (`id_user`, `group1_id`, `rating_supplier_id`),
  ...
  INDEX `fk_resident_user_rating1_idx` (`rating_supplier_id1` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_resident_user_group_leader1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_resident_user_rating1`
    FOREIGN KEY (`rating_supplier_id1`)
    REFERENCES `mydb`.`rating` (`supplier_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`transaction` (
  ...
  INDEX `fk_transaction_supplier_user1_idx` (`supplier_id` ASC) VISIBLE,
  INDEX `fk_transaction_resident_user1_idx` (`resident_id` ASC) VISIBLE,
  INDEX `fk_transaction_resource1_idx` (`resource_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_transaction_resource1`
    FOREIGN KEY (`resource_id`)
    REFERENCES `mydb`.`resource` (`id_resource`),
  CONSTRAINT `fk_transaction_supplier_user1`
